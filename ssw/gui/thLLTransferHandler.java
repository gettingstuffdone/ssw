...
/*     */ 
/*     */ 
/*     */ public class thLLTransferHandler
...
/*  57 */     d.Locked = this.CurMech.GetLoadout().GetLLCrits()[d.SourceIndex].LocationLocked();
/*  58 */     if ((this.CurMech.GetLoadout().GetLLCrits()[d.SourceIndex] instanceof EmptyItem)) {
/*  59 */       d.Empty = true;
/*     */     }
/*  61 */     return d;
/*     */   }
...
/*  86 */         if (DropItem.Location != 6) {
/*  87 */           return false;
/*     */         }
/*     */         
/*  90 */         JList.DropLocation dl = (JList.DropLocation)info.getDropLocation();
/*  91 */         int dindex = dl.getIndex();
/*  92 */         if ((this.CurMech.GetLoadout().GetCrits(6)[dindex].LocationLocked()) || (this.CurMech.GetLoadout().GetCrits(6)[dindex].LocationLinked())) {
/*  93 */           return false;
/*     */         }
/*  95 */         if ((a instanceof CASEII)) {
/*  96 */           if ((this.CurMech.IsOmnimech()) && (this.CurMech.GetBaseLoadout().GetLLCaseII() == a)) {
/*  97 */             return false;
/*     */           }
...
/* 105 */             return false;
/*     */           }
/* 107 */           if (a.NumCrits() + dindex > this.CurMech.GetLoadout().GetCrits(6).length) {
/* 108 */             return false;
/*     */           }
...
/* 112 */             return false;
/*     */           }
/* 114 */           if ((this.CurMech.GetLoadout().GetLLCrits()[dindex].LocationLocked()) || (this.CurMech.GetLoadout().GetLLCrits()[dindex].LocationLocked())) {
/* 115 */             return false;
/*     */           }
/*     */         }
/*     */         else {
...
/*     */         }
/*     */       } else {
/* 212 */         this.CurMech.GetLoadout().AddToLL(a, dindex);
/*     */       }
/*     */     } catch (Exception e) {
...
/* 229 */     int ToPlace = this.CurMech.GetLoadout().FreeFrom(this.CurMech.GetLoadout().GetLLCrits(), dindex);
/* 230 */     if (ToPlace < a.NumCrits()) {
/* 231 */       dlgSplitCrits dlgSplit = new dlgSplitCrits((JFrame)this.Parent, true, a, 6, dindex);
...
/*     */     }
/*     */     
/* 249 */     this.CurMech.GetLoadout().AddToLL(a, dindex);
...
/* Location:              C:\GDrive\SSW.jar!\ssw\gui\thLLTransferHandler.class
