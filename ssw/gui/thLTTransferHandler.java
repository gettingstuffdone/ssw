...
/*     */ 
/*     */ 
/*     */ public class thLTTransferHandler
...
/*  57 */     d.Locked = this.CurMech.GetLoadout().GetLTCrits()[d.SourceIndex].LocationLocked();
/*  58 */     if ((this.CurMech.GetLoadout().GetLTCrits()[d.SourceIndex] instanceof EmptyItem)) {
/*  59 */       d.Empty = true;
/*     */     }
/*  61 */     return d;
/*     */   }
...
/*  86 */         if (DropItem.Location != 2) {
/*  87 */           return false;
/*     */         }
/*     */         
/*  90 */         JList.DropLocation dl = (JList.DropLocation)info.getDropLocation();
/*  91 */         int dindex = dl.getIndex();
/*  92 */         if (((this.CurMech.GetLoadout().GetCrits(2)[dindex].LocationLocked()) || (this.CurMech.GetLoadout().GetCrits(2)[dindex].LocationLinked())) && (a != this.CurMech.GetLoadout().GetCrits(2)[dindex])) {
/*  93 */           return false;
/*     */         }
/*  95 */         if ((a instanceof CASE)) {
/*  96 */           if ((this.CurMech.IsOmnimech()) && (this.CurMech.GetBaseLoadout().GetLTCase() == a)) {
/*  97 */             return false;
/*     */           }
/*  99 */         } else if ((a instanceof CASEII)) {
/* 100 */           if ((this.CurMech.IsOmnimech()) && (this.CurMech.GetBaseLoadout().GetLTCaseII() == a)) {
/* 101 */             return false;
/*     */           }
...
/* 117 */           abPlaceable[] Loc = this.CurMech.GetLoadout().GetLTCrits();
/*     */           try {
...
/* 129 */             return false;
/*     */           }
/* 131 */           if ((this.CurMech.GetLoadout().GetLTCrits()[dindex].LocationLocked()) || (this.CurMech.GetLoadout().GetLTCrits()[dindex].LocationLocked())) {
/* 132 */             return false;
/*     */           }
/* 134 */         } else if ((a instanceof MechTurret)) {
/* 135 */           if ((this.CurMech.IsOmnimech()) && (this.CurMech.GetBaseLoadout().HasLTTurret())) {
/* 136 */             return false;
/*     */           }
...
/* 145 */           abPlaceable[] Loc = this.CurMech.GetLoadout().GetCrits(2);
/*     */           try {
...
/*     */         {
/* 221 */           abPlaceable[] loc = this.CurMech.GetLoadout().GetLTCrits();
/* 222 */           for (int i = 0; i < loc.length; i++) {
/* 223 */             if (loc[i] == a) loc[i] = this.CurMech.GetLoadout().GetNoItem();
/*     */           }
/* 225 */           this.CurMech.GetLoadout().AddToLT(a, dindex);
/*     */         }
/* 227 */         else if (DropItem.Location == 2) {
/* 228 */           LocationIndex loc1 = null;
/* 229 */           LocationIndex loc2 = null;
/* 230 */           for (int i = 0; i < v.size(); i++) {
/* 231 */             if (((LocationIndex)v.get(i)).Location == 2) {
...
/*     */       }
/*     */       else {
/* 259 */         this.CurMech.GetLoadout().AddToLT(a, dindex);
/*     */       }
/*     */     } catch (Exception e) {
...
/* 280 */     int ToPlace = this.CurMech.GetLoadout().FreeFrom(this.CurMech.GetLoadout().GetLTCrits(), dindex);
/* 281 */     if (ToPlace < a.NumCrits()) {
/* 282 */       dlgSplitCrits dlgSplit = new dlgSplitCrits((JFrame)this.Parent, true, a, 2, dindex);
...
/*     */     }
/*     */     
/* 300 */     this.CurMech.GetLoadout().AddToLT(a, dindex);
...
/* Location:              C:\GDrive\SSW.jar!\ssw\gui\thLTTransferHandler.class
